...
skills
    ...
    .action(async () => {
        const { discoverSkills, getSkillsDir } = await import('./skills/index.js');
...
skills
    ...
    .action(async (source) => {
        ...
        const { installSkillFromPath, installSkillFromGitRepo, isGitSource } =
...
skills
    ...
    .action(async (name) => {
        const { createSkill } = await import('./skills/index.js');
...
skills
    ...
    .action(async (name) => {
        const { loadSkill } = await import('./skills/index.js');
